...
const components:ScreenInfo[]=[
    ...
    {id:"Explore",component:Explore,type:"Partial",title:"Explore",props:["initialexploretab","programslistquery","universitieslistquery"],delay:200,swipeDirection:"X",animationStyle:"HorizontalSlideToLeft",removalThreshold:0.3},//,"Programslistquery","Universitieslistquery"  //["initialexploretab","programsadditionalfilters","programsquickfilters","universitiesadditionalfilters","universitiesquickfilters","search","universitiespage","programspage"]  //"courselistid","courseadditionalFilters","coursequickFilters","coursesearch","coursepage"
    ...
    {id:"Dp",component:Dp,typflise:"Popup",props:["image"],swipeDirection:"XY",isTransparent:true,occupyFullScreen:true,animationStyle:"FadeIn",removalThreshold:0.5},
    ...
    {id:"Experts",component:Experts,type:"Partial",title:"Experts",tutorialId:"Experts",swipeDirection:"X",animationStyle:"HorizontalSlideToLeft",removalThreshold:0.3},
    ...
    {id:"Error",component:Error,type:"Flyer",props:["error","preventAutoHide","hideInterval"],swipeDirection:"Y",animationStyle:"Custom",customPlacement:{initial:{x:0,y:1,scale:1,height:0.35,width:1,opacity:1},final:{x:0,y:0.65,scale:1,opacity:1,height:0.35,width:1}},removalThreshold:5/6},
    ...
    {id:"Program",component:Program,title:"Program",props:["programid"],type:"Partial",delay:200,occupyFullScreen:true,swipeDirection:"X",animationStyle:"HorizontalSlideToLeft",removalThreshold:0.3},
    {id:"University",component:University,title:"University",props:["universityid"],type:"Partial",delay:200,occupyFullScreen:true,swipeDirection:"X",animationStyle:"HorizontalSlideToLeft",removalThreshold:0.3},
    {id:"Intake",component:Intake,props:["intakebasketid"],type:"Flyer",swipeDirection:"Y",animationStyle:"VerticalSlideToTopPartial",removalThreshold:5/6},
    {id:"Documentview",component:Docview,props:["docpreviewurl"],type:"Flyer",swipeDirection:"Y",animationStyle:"VerticalSlideToTopPartial",removalThreshold:5/6},
