...
const components:ScreenInfo[]=[
    ...
    {id:"Error",component:Error,type:"Flyer",props:["error","preventAutoHide","hideInterval"],swipeDirection:"Y",animationStyle:"VerticalSlideToTopPartial",removalThreshold:5/6},
