...
const Phone=(props:{codes:DropdownType,id:string,value:{countryCode:Countrycode[],phoneNumber:string,verified:boolean}})=>{
    ...
    return(
        <View style={[GeneralStyles.wrapper]}>
        {
            ...
            :
            <View style={[GeneralStyles.sub_wrapper]}>
                <View style={{flex:1}}><Text style={[styles[Device].text,{color:Themes.Light.OnewindowPrimaryBlue(1),fontFamily:Fonts.NeutrifStudio.Regular}]}>{Word2Sentence([props.value.countryCode[0].dial_code,props.value.phoneNumber],""," ")}</Text></View>
